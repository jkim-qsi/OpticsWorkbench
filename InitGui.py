...
class OpticsWorkbench (Workbench):
    ...
    def Initialize(self):
        ...
        self.list = ['Ray (monochrome)', 'Ray (sun light)', 'Beam', '2D Radial Beam', 'Spherical Beam', 'Mirror', "Grating", 'Absorber', 'Lens', 'Off', 'Start', 'Plot', 'PlotAngles'] # A list of command names created in the line above
